...
static const std::pair<TextureAsset, AssetTexture> TEXTURE_ASSETS[] = {
    ...
    { TextureAsset::UiCategoryPanelBackground, AssetTexture("assets/sprites/ui/PanelGrayscale.png", sge::TextureSampler::Linear) },
    { TextureAsset::UiCategoryPanelBorder,     AssetTexture("assets/sprites/ui/CategoryPanelBorder.png", sge::TextureSampler::Linear) },
    { TextureAsset::UiLogo,                    AssetTexture("assets/sprites/ui/Logo.png", sge::TextureSampler::Linear) },
    { TextureAsset::UiIconRandomName,          AssetTexture("assets/sprites/ui/IconRandomName.png", sge::TextureSampler::Linear) },
    ...
    { TextureAsset::UiWorldPreviewSizeMedium,        AssetTexture("assets/sprites/ui/PreviewSizeMedium.png", sge::TextureSampler::Nearest) },
    { TextureAsset::UiWorldPreviewSizeLarge,         AssetTexture("assets/sprites/ui/PreviewSizeLarge.png", sge::TextureSampler::Nearest) },
...
const std::pair<ShaderAsset, AssetShader> SHADER_ASSETS[] = {
    ...
    { ShaderAsset::FontShader,           AssetShader("font",         ShaderStages::Fragment,                        {}) },
};
...
bool Assets::Load(sge::RenderContext& context) {
    ...
    state.textures_atlases[TextureAsset::Backgrounds] = sge::TextureAtlas(Assets::GetTexture(TextureAsset::Stub), std::move(background_rects), glm::uvec2(0), 0, 0);
