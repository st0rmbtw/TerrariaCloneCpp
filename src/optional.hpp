...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
  ...
  TL_OPTIONAL_11_CONSTEXPR optional disjunction(const optional &rhs) && {
    return is_some() ? std::move(*this) : rhs;
  }
  ...
  TL_OPTIONAL_11_CONSTEXPR optional disjunction(optional &&rhs) & {
    return is_some() ? *this : std::move(rhs);
  }
  ...
  TL_OPTIONAL_11_CONSTEXPR optional disjunction(optional &&rhs) && {
    return is_some() ? std::move(*this) : std::move(rhs);
  }
 ...
 template <class... Args>
  ...
  constexpr bool is_some() const noexcept { return this->m_has_value; }
  ...
  template <class U>
  inline constexpr bool is_some_and_not_eq(const U &rhs) const {
    return this->is_some() ? *this != rhs : false;
  }
  ...
  template <class U> constexpr T value_or(U &&u) const & {
    ...
    return is_some() ? **this : static_cast<T>(std::forward<U>(u));
  }
  ...
  template <class U> TL_OPTIONAL_11_CONSTEXPR T value_or(U &&u) && {
    ...
    return is_some() ? std::move(**this) : static_cast<T>(std::forward<U>(u));
  }
...
inline constexpr bool operator<(const optional<T> &lhs,
                                const optional<U> &rhs) {
  return rhs.is_some() && (!lhs.is_some() || *lhs < *rhs);
}
template <class T, class U>
inline constexpr bool operator>(const optional<T> &lhs,
                                const optional<U> &rhs) {
  return lhs.is_some() && (!rhs.is_some() || *lhs > *rhs);
}
template <class T, class U>
inline constexpr bool operator<=(const optional<T> &lhs,
                                 const optional<U> &rhs) {
...
inline constexpr bool operator==(const optional<T> &lhs, const U &rhs) {
  return lhs.is_some() ? *lhs == rhs : false;
}
template <class T, class U>
inline constexpr bool operator==(const U &lhs, const optional<T> &rhs) {
  return rhs.is_some() ? lhs == *rhs : false;
}
template <class T, class U>
inline constexpr bool operator!=(const optional<T> &lhs, const U &rhs) {
  return lhs.is_some() ? *lhs != rhs : true;
}
template <class T, class U>
inline constexpr bool operator!=(const U &lhs, const optional<T> &rhs) {
  return rhs.is_some() ? lhs != *rhs : true;
}
template <class T, class U>
inline constexpr bool operator<(const optional<T> &lhs, const U &rhs) {
  return lhs.is_some() ? *lhs < rhs : true;
