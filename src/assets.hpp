...
enum class TextureAsset : uint8_t {
    ...
    UiPanelBackground,
    UiPanelBorder,
    UiCategoryPanelBackground,
    UiCategoryPanelBorder,
    UiLogo,
    UiIconRandomSeed,
    UiIconRandomName,
    UiSeparator1,
    UiSeparator2,
    UiWorldPreviewDifficultyNormal1,
    UiWorldPreviewDifficultyNormal2,
    UiWorldPreviewSizeMedium,
    UiWorldPreviewSizeLarge,
    UiWorldPreviewEvilRandom,
    UiWorldPreviewBorder,
    UiSliderHandle,

    UiWorldIconCorruption,
    UiWorldIconCrimson,
    UiWorldIconCorruptionCrimson,
