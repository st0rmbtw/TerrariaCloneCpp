...
Item ITEM_DIRT_BLOCK = {
    ...
    .max_stack = 9999,
    .stack = 1,
    .places_tile = PlacesTile(BlockType::Dirt),
    .swing_speed = 15,
    .use_cooldown = 0,
    .power = 0,
    .consumable = true,
...
Item ITEM_STONE_BLOCK = {
    ...
    .max_stack = 9999,
    .stack = 1,
    .places_tile = PlacesTile(BlockType::Stone),
    .swing_speed = 15,
    .use_cooldown = 0,
    .power = 0,
    .consumable = true,
...
Item ITEM_TORCH = {
    ...
    .max_stack = 9999,
    .stack = 1,
    .places_tile = PlacesTile(BlockType::Torch),
    .swing_speed = 15,
    .use_cooldown = 0,
    .power = 0,
    .consumable = true,
...
Item ITEM_WOOD_BLOCK = {
    ...
    .max_stack = 9999,
    .stack = 1,
    .places_tile = PlacesTile(BlockType::Wood),
    .swing_speed = 15,
    .use_cooldown = 0,
    .power = 0,
    .consumable = true,
